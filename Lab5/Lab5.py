...
class BuildingProximity(object):
    ...
    def updateParameters(self, parameters):
        """Modify the values and properties of parametersbefore internal 
        validation is performed. This meoths is called whenever a parameter 
        has been changed."""
        return
    ...
    def execute(self, parameters, messages):
        ...
        folder_path = parameters[3].valueAsText
        ...
        arcpy.TableToTable_conversion( gdb_path + '\Garage_Building_Intersect', r'C:\Users\sbing\TAMU\GEOG676\bingham-online-GEOG676-spring2026\Lab4', 'nearbyBuildings')
